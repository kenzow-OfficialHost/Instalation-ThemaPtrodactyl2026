    ...
    return (
        <PageContentBlock title={'Dashboard'} showFlashKey={'dashboard'}>
            ...
            <div className="homeServers">
                <h2>ABOUT & SOSIAL MEDIA ADMIN</h2>
                <div className="tarifBox">
                    <div className="tarif">
                        <img style={{borderRadius:'10px'}} src="/themes/enigma_premium/img/wa_logo.png" alt="" />
                        <h2>WA ADMIN</h2>
                        <p>contact admin</p>
                        <a href="LINK_WA">CHAT</a>
                    </div>
                    <div className="tarif">
                        <img style={{borderRadius:'10px'}} src="/themes/enigma_premium/img/group_logo.png" alt="" />
                        <h2>GROUP ADMIN</h2>
                        <p>join sekarang !!</p>
                        <a href="LINK_GROUP">Masuk</a>
                    </div>
                    <div className="tarif">
                        <img style={{borderRadius:'10px'}} src="/themes/enigma_premium/img/channel_logo.png" alt="" />
                        <h2>CHANNEL WA</h2>
                        <p>follow sekarang !!</p>
                        <a href="LINK_CHNL">Follow</a>
                    </div>
                </div>
                <h2>SERVER ANDA</h2>
